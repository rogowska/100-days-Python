...
if answer.lower() != "wait":
  ...
  exit()
answer = input("You found a tower and have three doors to choose from. Do you want to go through green, red or yellow door? [red/blue/yellow]\n")
if answer.lower() != "yellow":
    print("You got eaten by the beast inside. Game over.")
    exit()
else:
  print("You won!")